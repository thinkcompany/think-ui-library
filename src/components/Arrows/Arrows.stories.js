const FullSectionRightTemplate = () => {
  ...
  <div class="tco-container-wrapper" style="position:relative;margin:20vh 0;">
      ...
      <div class="tco-text-only tco-section-arrow tco-section-arrow--full-right tco-text-only--capabilities">
        <p class="tco-type-eyebrow">Capabilities</p>
        <h3 class="tco-type-display--large-64 tco-type-display--has-br">We're experts in <strong>design</strong>, </br><strong>development</strong>, and <strong>product </br>management</strong>. Here's everything </br>we do to make your products </br>and services succeed.</h3>
  ...
  <div class="tco-container-wrapper tco-container-wrapper--glass">
    <div class="tco-container tco-container--center tco-container--mid" style="padding-top:min(34vw, 290px);">
      <div class="tco-text-only tco-text-only--center  ">
        <h2 class="tco-text-only-heading tco-type-display--medium">Our growing team of over 150 Thinkers can tackle some of your greatest challenges.</h2>
