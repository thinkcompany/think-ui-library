const renderForm = () => `
<div class="gf_browser_chrome gform_wrapper newsletter-form_wrapper" id="gform_wrapper_21">
  <form method="post" enctype="multipart/form-data" id="gform_21" class="newsletter-form" action="/events/">
    <div class="gform_body">
      <ul id="gform_fields_21" class="gform_fields top_label form_sublabel_below description_below">
        ...
        <li id="field_21_2" class="gfield gform_validation_container field_sublabel_below field_description_below gfield_visibility_visible">
          <label class="gfield_label" for="input_21_2">Your email</label>
          <div class="ginput_container"><input name="input_2" id="input_21_2" type="text" value="" /></div>
          <div class="gfield_description" id="gfield_description_21_2">This field is for validation purposes and should be left unchanged.</div>
        </li>
      </ul>
    </div>
    <div class="gform_footer top_label">
      <input
        ...
        value="Sign me up"
        tabindex="10112"
        onclick='if(window["gf_submitting_21"]){return false;}  window["gf_submitting_21"]=true;  '
        onkeypress='if( event.keyCode == 13 ){ if(window["gf_submitting_21"]){return false;} window["gf_submitting_21"]=true;  jQuery("#gform_21").trigger("submit",[true]); }'
      />
      <input type="hidden" class="gform_hidden" name="is_submit_21" value="1" />
      <input type="hidden" class="gform_hidden" name="gform_submit" value="21" />

      <input type="hidden" class="gform_hidden" name="gform_unique_id" value="" />
      <input type="hidden" class="gform_hidden" name="state_21" value="WyJbXSIsIjI1YTJhNzMyM2M5MmJhMDNiMmMzYTdkNDU2MDFkZGQ0Il0=" />
